...
!
      ...
      INTEGER (KIND=2) :: NUMBER_OF_BC_ADDENDUM_CLASSES=0, &
      	MAX_BC_ADDENDUM_CLASS_ID_NUM=0
      INTEGER (KIND=2) :: NUMBER_OF_OL_ADDENDUM_CLASSES=0, &
      	MAX_OL_ADDENDUM_CLASS_ID_NUM=0
      INTEGER (KIND=2) :: UNIT_NUM=10,ASSET_CLASS_NUM,ASSET_CLASS_VECTOR
      INTEGER (KIND=2) :: R_NUM_OF_ADDENDUM_CLASSES,R_MAX_ADDENDUM_CLASS_NUM, &
      	R_ADDENDUM_CLASS_POINTERS(*)
      INTEGER (KIND=2) :: R_UNIT_NUM,I
      CHARACTER (LEN=1) :: DATA_TYPE,DUMMY
      CHARACTER (LEN=30) :: ADDENDUM_CLASSIFICATION
      CHARACTER (LEN=30) :: PAYMENTS_CLASSIFICATION, &
      	INVESTMENT_CLASSIFICATION,RATE_BASE_CLASSIFICATION, &
      		CD_CIAC_CLASSIFICATION, &
                  WORKING_CAPITAL_CLASSIFICATION, &
                  SALE_REMOVAL_CLASSIFICATION, &
                  SHAREHOLDER_CLASSIFICATION,TRANSFER_CLASSIFICATION, &
                  OTHER_CLASSIFICATION,FUNDS_CLASSIFICATION, &
                  ACTUALS_CLASSIFICATION,FASB143_ARO_CLASSIFICATION
...
! DECLARATION FOR /ADDENDUM FILE/
      ...
      INTEGER :: ACCTNO
      REAL (KIND=4) :: ADDENDUM_VALUES(AVAIL_DATA_YEARS+1), &
      	CASH_ACCRUAL_AMOUNT,CASH_VALUES_VECTOR
      CHARACTER (LEN=16) :: FILE_TYPE='Addendums'
      CHARACTER (LEN=2) :: ADDENDUM_OL='BC',R_ADDENDUM_OL
      INTEGER (KIND=2) :: ADDENDUM_BC_ASSET_CLASS_POINTER(:), &
      	ADDENDUM_OL_ASSET_CLASS_POINTER(:),TEMP_ASSET_CLASS_POINTER(:)
      ALLOCATABLE :: ADDENDUM_BC_ASSET_CLASS_POINTER,ADDENDUM_OL_ASSET_CLASS_POINTER,TEMP_ASSET_CLASS_POINTER
      SAVE ADDENDUM_BC_ASSET_CLASS_POINTER, &
      	ADDENDUM_OL_ASSET_CLASS_POINTER
...
! CONVERT THE ADDENDUM FILE
      ...
      FILE_NAME = trim(BASE_FILE_DIRECTORY())//"ADB"// &
      ...
      IF(FILE_EXISTS) THEN
         ...
         OPEN(11,FILE=trim(DATA_DRIVE)//"BCADDEN.BIN", &
...
!                      
            DO
               ...
               READ(RECLN,*,ERR=200) DELETE,ACCTNO,CD_CIAC_CLASSIFICATION, &
               WORKING_CAPITAL_CLASSIFICATION,ADDENDUM_VALUES, &
               DESCRIPTION,COMMENT,DATA_TYPE,ESCALATION_VECTOR,ASSET_CLASS_NUM, &
               ASSET_CLASS_VECTOR, ADDENDUM_CLASSIFICATION, &
               PAYMENTS_CLASSIFICATION,INTRA_COMPANY_TRANSACTION, &
               INTRA_ASSET_CLASS_ID,INTRA_ASSET_CLASS_ALLOCATION, &
               INTRA_ACCOUNT_CLASSIFICATION, &
               INTRA_ADDENDUM_COLLECTION,BOOK_VALUES_VECTOR,CASH_TYPE, &
               CASH_VALUES_VECTOR, &
               CASH_ACCRUAL_AMOUNT,INVESTMENT_CLASSIFICATION, &
               RATE_BASE_CLASSIFICATION, &
               SALE_REMOVAL_CLASSIFICATION,SHAREHOLDER_CLASSIFICATION, &
               TRANSFER_CLASSIFICATION, &
               OTHER_CLASSIFICATION,FUNDS_CLASSIFICATION, &
               ACTUALS_CLASSIFICATION,ACCOUNT_ACTIVE, & ! 60 VALUES
               FASB143_ARO_CLASSIFICATION,DUMMY,DUMMY,DUMMY,DUMMY, &
               MIDAS_MONTHLY_BOOKED, & ! 66 VALUES
...
!
               ...
               IREC = IREC + 1
               WRITE(11,REC=IREC) DELETE,ACCTNO,CD_CIAC_CLASSIFICATION, &
               WORKING_CAPITAL_CLASSIFICATION,ADDENDUM_VALUES,DATA_TYPE, &
               ESCALATION_VECTOR,ASSET_CLASS_NUM,ASSET_CLASS_VECTOR, &
               ADDENDUM_CLASSIFICATION, &
               PAYMENTS_CLASSIFICATION,INTRA_COMPANY_TRANSACTION, &
               INTRA_ASSET_CLASS_ID, &
               INTRA_ASSET_CLASS_ALLOCATION,INTRA_ACCOUNT_CLASSIFICATION, &
               INTRA_ADDENDUM_COLLECTION, &
               BOOK_VALUES_VECTOR,CASH_TYPE,CASH_VALUES_VECTOR, &
               CASH_ACCRUAL_AMOUNT,INVESTMENT_CLASSIFICATION, &
               RATE_BASE_CLASSIFICATION,SALE_REMOVAL_CLASSIFICATION, &
               SHAREHOLDER_CLASSIFICATION, &
               TRANSFER_CLASSIFICATION,OTHER_CLASSIFICATION, &
               FUNDS_CLASSIFICATION,ACTUALS_CLASSIFICATION, &
               FASB143_ARO_CLASSIFICATION,ACCOUNT_ACTIVE,DESCRIPTION, &
         ...
         IF(MAX_BC_ADDENDUM_CLASS_ID_NUM > 0) THEN
            ALLOCATE(ADDENDUM_BC_ASSET_CLASS_POINTER &
            	(MAX_BC_ADDENDUM_CLASS_ID_NUM))
            ADDENDUM_BC_ASSET_CLASS_POINTER =  &
            TEMP_ASSET_CLASS_POINTER(1:MAX_BC_ADDENDUM_CLASS_ID_NUM)
         ENDIF
...
!
      ELSE IF(INDEX(BASE_FILE_NAME,'NONE') == 0) THEN
         CALL STOP_NOFILE(FILE_TYPE,FILE_NAME, "msgmmadm:1111")
      ENDIF
      RETURN
...
! OVERLAY THE ADDENDUM FILE
      ...
      DO
         DO
            ...
            READ(INUNIT,REC=IREC,IOSTAT=IOS_BASE) DELETE,ACCTNO, &
            	CD_CIAC_CLASSIFICATION,WORKING_CAPITAL_CLASSIFICATION, &
                ADDENDUM_VALUES,DATA_TYPE,ESCALATION_VECTOR, &
                ASSET_CLASS_NUM,ASSET_CLASS_VECTOR, &
                ADDENDUM_CLASSIFICATION,PAYMENTS_CLASSIFICATION, &
                INTRA_COMPANY_TRANSACTION, &
                INTRA_ASSET_CLASS_ID,INTRA_ASSET_CLASS_ALLOCATION, &
                INTRA_ACCOUNT_CLASSIFICATION, &
                INTRA_ADDENDUM_COLLECTION,BOOK_VALUES_VECTOR, &
                CASH_TYPE,CASH_VALUES_VECTOR,CASH_ACCRUAL_AMOUNT, &
                INVESTMENT_CLASSIFICATION,RATE_BASE_CLASSIFICATION, &
                SALE_REMOVAL_CLASSIFICATION, &
                SHAREHOLDER_CLASSIFICATION,TRANSFER_CLASSIFICATION, &
                OTHER_CLASSIFICATION,FUNDS_CLASSIFICATION, &
                ACTUALS_CLASSIFICATION,FASB143_ARO_CLASSIFICATION, &
                ACCOUNT_ACTIVE,DESCRIPTION, &
                MIDAS_MONTHLY_BOOKED, &                                                 ! 60 VALUES
                MIDAS_MONTHLY_DATA_UNITS, &                                             ! 5 VALUES
                MIDAS_LAST_MONTH, &                                                     ! 5 VALUES
                ANNUAL_VALUE_STATUS, &                                                  ! 5 VALUES
            ...
            IF(IOS == 0) THEN
               ...
               READ(RECLN,*,ERR=200) DELETE,ACCTNO,CD_CIAC_CLASSIFICATION, &
               WORKING_CAPITAL_CLASSIFICATION,ADDENDUM_VALUES, &
               TEMP_DESCRIPTION,COMMENT,DATA_TYPE,ESCALATION_VECTOR, &
               ASSET_CLASS_NUM,ASSET_CLASS_VECTOR, &
               ADDENDUM_CLASSIFICATION,PAYMENTS_CLASSIFICATION, &
               INTRA_COMPANY_TRANSACTION, &
               INTRA_ASSET_CLASS_ID,INTRA_ASSET_CLASS_ALLOCATION, &
               ...
               SALE_REMOVAL_CLASSIFICATION,SHAREHOLDER_CLASSIFICATION, &
               TRANSFER_CLASSIFICATION, &
               OTHER_CLASSIFICATION,FUNDS_CLASSIFICATION,ACTUALS_CLASSIFICATION, &
               ACCOUNT_ACTIVE, &  ! 60 VALUES
               FASB143_ARO_CLASSIFICATION,DUMMY,DUMMY,DUMMY,DUMMY, &
               MIDAS_MONTHLY_BOOKED, &          ! 66 VALUES
               MIDAS_MONTHLY_DATA_UNITS, &                                                         ! 5 VALUES
               MIDAS_LAST_MONTH, &                                                                 ! 5 VALUES
      ...
      ADDENDUM_OL= 'OL'
      IF(ALLOCATED(ADDENDUM_OL_ASSET_CLASS_POINTER)) THEN
      	DEALLOCATE(ADDENDUM_OL_ASSET_CLASS_POINTER)
      END IF
      IF(MAX_OL_ADDENDUM_CLASS_ID_NUM > 0) THEN
         ALLOCATE(ADDENDUM_OL_ASSET_CLASS_POINTER(MAX_OL_ADDENDUM_CLASS_ID_NUM))
         ADDENDUM_OL_ASSET_CLASS_POINTER = &
         	TEMP_ASSET_CLASS_POINTER(1:MAX_OL_ADDENDUM_CLASS_ID_NUM)
      ENDIF
      DEALLOCATE(TEMP_ASSET_CLASS_POINTER)
...
!
      ...
      INTEGER (KIND=2) :: I,IREC,DELETE,ESCAL_VECT,CLASS_POINTER, &
      	NUM_OF_ASSET_CLASSES,FINANCIAL_SIMULATION_YEARS
      INTEGER (KIND=4) :: IOS
...
!
      INTEGER (KIND=2) :: ASSET_ALLOCATION_VECTOR,ASSET_CLASS,RUN_YEARS, &
      	EXTENSION_YEARS,WVPA_COMPANY_ID  ! 141
      INTEGER ACCTNO
      REAL (KIND=4) :: ESCALATION_MULTIPLIER,ASSET_ALLOCATOR,MULTIPLIER
!
!     TYPE DECLARATION FOR /WKARRY/
!
      REAL (KIND=4) :: ADDENDUM_VALUES(:),ALLOC_EXPEN(:,:), &
      ADDENDUM(:),ASSET_CLASS_LIST(:),ASSET_ALLOCATION_LIST(:)
      ALLOCATABLE :: ALLOC_EXPEN,ADDENDUM_VALUES, &
      	ADDENDUM,ASSET_CLASS_LIST,ASSET_ALLOCATION_LIST
!
!  SECTION
!
...
!
      CHARACTER (LEN=30) :: PAYMENTS_CLASSIFICATION, &
      	INVESTMENT_CLASSIFICATION,RATE_BASE_CLASSIFICATION, &
      		CD_CIAC_CLASSIFICATION, &
            WORKING_CAPITAL_CLASSIFICATION,SALE_REMOVAL_CLASSIFICATION, &
            	TRANSFER_CLASSIFICATION,OTHER_CLASSIFICATION, &
            FUNDS_CLASSIFICATION,SHAREHOLDER_CLASSIFICATION, &
            ADDENDUM_CLASSIFICATION,ACTUALS_CLASSIFICATION, &
            FASB143_ARO_CLASSIFICATION,DESCRIPTION,DATA_BASE_CLASSIFICATION
      LOGICAL (KIND=1) :: IN_WVPA_DATA_BASE
!
      REAL (KIND=4) , ALLOCATABLE ::  PAYMENTS(:,:,:,:), &
      	INVESTMENTS(:,:,:,:),RATE_BASE(:,:,:,:), &
      	WORKING_CAPITAL(:,:,:,:), &
        CD_CIAC(:,:,:,:),SALE_REMOVAL(:,:,:,:), &
        SHAREHOLDER_VALUE(:,:,:,:),TRANSFER_VALUE(:,:,:,:), &
        CASH_MONTHLY_VALUES(:,:,:,:),OTHER_VALUE(:,:,:,:), &
        FUNDS_EARNINGS(:,:,:,:), &
        ACTUAL_MONTHLY_VALUES(:,:,:,:),FASB143_ARO_VALUE(:,:,:,:), &
        CapX_Values(:,:,:,:), &
        WVPA_ADDENDUM_ITEMS(:,:,:,:)
      LOGICAL (KIND=1) , ALLOCATABLE :: ACTUAL_VALUE_FOUND(:,:)
!
      REAL (KIND=4) :: MIDAS_MONTHLY_BOOKED(12,LAST_AVAILABLE_MONTHLY_YEAR), &
      	MIDAS_MONTHLY_CASH(12,LAST_AVAILABLE_MONTHLY_YEAR), &
        MIDAS_ANNUAL_CASH(0:AVAIL_DATA_YEARS), &
      ...
      CHARACTER (LEN=30) :: TEMP_MIDAS_MONTHLY_DATA_UNITS( &
...
!
!
      REAL (KIND=4) :: R_CASH_VALUES(0:12,*), &
      R_INCOME_VALUES(0:12,*), &
      	R_BALANCE_SHEET_VALUES(0:12,*), &
            R_MONTHLY_NUC_DECOM_CASH_VALUES(0:12), &
            R_MTHLY_NUC_DECOM_EARNGS_ADDEM(0:12), &
            R_MTHLY_POST_RETIRMT_CASH_PAYMS(0:12), &
            MONTHLY_CASH_TO_POST_RETIREMENT(0:12), &
            MTHLY_CASH_2_MBR_ACCRD_REVS_BAL(0:12), &
            R_MTHLY_RETIREE_MED_CASH_PAYMTS(0:12), &
            R_MTHLY_RETRMNT_FUND_EARNGS_ADJ(0:12), &
            R_MONTHLY_BOOK_DEPRECIATION(0:12)
!
      REAL (KIND=4) :: R_BOOK_DEPRECIATION
      LOGICAL (KIND=1) :: CLASSIFICATON_IS_ACTUAL
      LOGICAL (KIND=1) :: FALSE_BYTE,WVPA
!
      INTEGER (KIND=2) :: R_FINANCIAL_SIMULATION_YEARS, &
      	R_NUM_OF_ASSET_CLASSES
      REAL (KIND=4) :: R_ADDENDUM_ARRAY(0:12,0:R_FINANCIAL_SIMULATION_YEARS, &
      	-1:R_NUM_OF_ASSET_CLASSES,*)
...
!
      REAL (KIND=4) :: R_PENSION_EXPENSE_CASH,R_STORM_EXPENSE_CASH, &
      R_VACATION_PAY_CASH
      REAL (KIND=4) :: R_ACTUAL_DEFERRED_TAXES_CR(0:12), &
      	R_ACTUAL_FED_INCOME_TAXES(0:12),R_ACTUAL_STATE_INCOME_TAXES(0:12), &
             R_ACTUAL_DEFERRED_TAXES_DR(0:12)
      REAL (KIND=4) :: ANNUAL_AMOUNT,MONTHLY_AMOUNT
      INTEGER (KIND=2) :: MO2
      REAL (KIND=4) :: UNALLOCATED_BALANCE,ANNUAL_TARGET_VALUE,RATIO, &
      	REMAINING_ANNUAL_BALANCE
!
      REAL (KIND=4) :: R_DIVIDEND_SUBSIDIARY, &
      	R_NET_INCOME_SUBSIDIARY,R_INVESTMENT_IN_SUBSIDIARY,R_OTHER_INVESTMENTS, &
      ...
      REAL (KIND=4) :: R_EARNINGS_DECOMMISSIONING_FUND, &
      	R_EARNINGS_POST_RETIREMENT_FUND,R_EARNINGS_ST_INVESTMENTS, &
             R_EARNINGS_LT_INVESTMENTS
      REAL (KIND=4) :: R_CD_BALANCE_FROM_REVENUES, &
      	R_CD_ADDENDUM,R_CIAC_CASH_CONTRIBUTIONS,R_CIAC_AMORTIZATION_RATE, &
             R_CIAC_ADDENDUM_TO_AMORTIZATION
      REAL (KIND=4) :: R_ASSETS_NEC_ADDENDUM,R_LIABILITIES_NEC_ADDENDUM, &
      	R_FUEL_INVENTORY_CHANGE_IN,R_MATERIALS_SUPPLIES_IN, &
             R_GAS_STORAGE_IN,R_FUEL_INVENTORY_OUT,R_MATERIALS_SUPPLIES_OUT, &
             R_GAS_STORAGE_OUT,R_ACCT_RECEIVABLE_RATE, &
             R_ACCT_RECEIVABLE_ADDEN,R_ACCT_PAYABLE_RATE,R_ACCT_PAYABLE_ADDEN
      REAL (KIND=4) :: R_NET_REMOVAL,R_CASH_RECEIVED,R_GROSS_BOOK_VALUE, &
      	R_CUMULATIVE_DEPRECIATION,R_DEFERRED_TAXES_ADJUSTMENT, &
             R_ATL_AMORTIZATION,R_BTL_AMORTIZATION,R_ADDEDUM_TO_BOOK_GAIN_LOSS
      REAL (KIND=4) :: R_EQUITY_RISK_ADJUSTMENT,R_ECONOMIC_ASSETS_ADJUSTMENT, &
      R_OPERATING_PROFITS_ADJUSTMENT, &
             R_CAP_RECOVERY_EXCLUDE_OPAT
      REAL (KIND=4) :: R_GROSS_PLANT_VALUE,R_CUMULATED_PLANT_DEPRECIATION, &
      R_DEFERRED_TAXES_BAL_ADJ,R_DEFERRED_DEBIT_ADJUSTMENT, &
             R_NET_DEFERRED_DEBIT_ADJUSTMENT,R_ATL_DEBIT_AMORTIZATION, &
             R_BTL_DEBT_AMORTIZATION,R_ANNUAL_DEFERRED_TAXES, &
             R_DEFERRED_ITCS_BAL_ADJ,R_NET_NUCLEAR_FUEL_ADJ, &
             R_RETAINED_EARNINGS_ADJ,R_EXTRA_ORDINARY_EXPENSE, &
             R_LT_LIAB_BAL_ADJ, &
             R_CWIP_BALANCE_ADJ,R_DEFERRED_TAXES_DR,R_PAID_IN_CAPITAL, &
             R_SUBSIDIARY_INVESTMENT_ADJ,R_GOODWILL_ADJUSTMENT, &
             R_REG_ASSESTS_ADJUSTMENT,R_FASB109_ADJUSTMENT, &
             	R_FASB133_ADJUSTMENT,R_UNAMORT_INTEREST_ADJUSTMENT, &
             R_NUCLEAR_DECOM_FUND_BAL,R_CAP_LEASES_BAL,R_ASSETS_NEC_BAL, &
             R_PREFERRED_STOCK_BAL,R_LTD_BAL,R_STD_BAL, &
             R_NUC_DECOM_LIAB_BAL,R_LIABS_NEC_BAL,R_OTHER_INVESTMENT_BAL, &
             R_NOTES_RECEIVABLE_BAL,R_POST_RETIRE_MEDICAL_BAL, &
             R_DEFERRED_REVENUES_BAL,R_DEFERRED_FUEL_BAL, &
             R_DEFERRED_PURCH_GAS_BAL,R_LT_INVEST_BAL,R_ST_INVEST_BAL, &
             R_FUEL_INVENTORY_BAL,R_GAS_IN_STORAGE_BAL, &
             R_MATRIAL_SUPPLY_BAL,R_ACCOUNTS_RECV_BAL,R_UNBILLED_REV_BAL, &
             R_TAXES_RECEIVABLE_BAL,R_CURRENT_LT_DEBT_BAL, &
             R_NOTES_PAYABLE_BAL,R_CUSTOMER_DEPOSIT_BAL,R_CICA_BAL, &
             R_POST_RETIRE_PAYABLE_BAL,R_ACCRUED_PENSION_BAL, &
             R_DEFERRED_GAINS_BAL,R_STROM_RESERVE_BAL,R_ACCOUNTS_PAYABLE_BAL, &
             R_ARO_NET_ASSETS,R_ARO_LIABILITY,R_DEFERRED_PURCHASE_POWER_ADJ, &
             R_COI_EARNINGS
!
      REAL (KIND=4) :: R_SRP_TARGET_SALES, &
      R_GRE_PRINCIPAL_MANUAL_ADJS,R_GRE_INT_PAYMENTS_MANUAL_ADJS, &
             IPL_ELECTRIC_PLAN_FUEL_COSTS(0:12),IPL_ELECTRIC_PLAN_PUR_COSTS(0:12)
      REAL (KIND=4) :: GPV_ADJUSTMENT,DEF_TAX_ADJUSTMENT,DEF_DEBIT_ADJUSTMENT, &
      CWIP_BALANCE_ADJ,LT_LIAB_BAL_ADJ,NET_NUC_FUEL_ADJ, &
             CAPITAL_LEASE_ADJ,R_TRANSFER_VARIABLES(0:12,*), &
             R_DEFERRED_GAIN_ADJ(0:12),R_ASSET_NEC_ADDENDUM(0:12), &
             R_LIABS_NEC_ADDENDUM(0:12)
!
      REAL (KIND=4) :: R_CIAC_MONTHLY_AMORT_RATE(0:12),&
      	R_CIAC_MONTHLY_ADDENDUM_2_AMORT(0:12),R_CIAC_MONTHLY_CASH(0:12)
      REAL (KIND=4) :: R_DECOMMISSIONING_FUND,R_DECOMMISSIONING_LIABILITY, &
      R_POST_RETIREMENT_MEDICAL,R_RETIREE_MEDICAL_PAYMENTS
      REAL (KIND=4) :: R_NucDecom_Discount_Rate,R_NucDecom_Interest_Accretion, &
      	R_ARO_Cash_Payment,R_ARO_Trust_Cash_Payment, &
! Merge2issue: left side used R_MO_NucDecom_Interest_Accretion and 
             R_MO_NucDecom_Discount_Rate(0:12), &
             R_MO_NucDecom_Int_Accretion(0:12),R_MO_ARO_Cash_Payment(0:12), &
             R_MO_ARO_Trust_Cash_Payment(0:12), &
             R_MO_ARO_NET_ASSETS(0:12),R_MO_ARO_LIABILITY(0:12), &
             R_OCI_ADJ(0:12), &
             R_INTANGIBLE_ASSET_ADJ(0:12),R_PENSION_LIABILITY_ADJ(0:12), &
             R_OCI_DEFERRED_TAX_ADJ_DR(0:12)
      CHARACTER (LEN=1) :: ACCOUNT_ACTIVE
      REAL (KIND=4) :: R_STD_RATE,R_MONTHLY_STD_RATE(0:12), &
      R_RETURN_ON_ST_INVEST,R_INTEREST_ON_CUSTOMER_DEPOSITS,R_RETURN_ON_LTI, &
             R_RETURN_RETIREMENT_FUND,R_NUCL_DECOM_FUND_RETURN, &
             R_OCI_NUCL_DECOM_FUND_RETURN,R_OCI_RETURN_RETIREMENT_FUND, &
             R_MONTHLY_STI_RATE(0:12),R_MONTHLY_CUST_DEPOSITS_RATE(0:12), &
             R_MONTHLY_LTI_RATE(0:12), &
             R_MONTHLY_RETIREMENT_FUND_RATE(0:12), &
             R_MONTHLY_NUC_DECOM_RATE(0:12),OCI_MTHLY_RETIREMENT_FUND_RATE(0:12), &
             OCI_MONTHLY_NUC_DECOM_RATE(0:12)
      REAL (KIND=4) :: CASH_TO_CASH,CASH_TO_POST_RETIRE_MEDICAL_BAL, &
      CASH_TO_ACCRD_MBR_REVENUES_BAL
!
      FINANCIAL_SIMULATION_YEARS = MAX(RUN_YEARS() + &
      	EXTENSION_YEARS(),LAST_AVAILABLE_MONTHLY_YEAR)
...
!
      DO
         IREC = IREC + 1
         READ(11,REC=IREC,IOSTAT=IOS) DELETE,ACCTNO,CD_CIAC_CLASSIFICATION, &
         WORKING_CAPITAL_CLASSIFICATION, &
...
!
         ...
         CALL CREATE_DOLLAR_STREAM(FINANCIAL_SIMULATION_YEARS,DATA_TYPE, &
         	ESCAL_VECT,ADDENDUM_VALUES,ADDENDUM)
...
!
            ...
            IF(CLASSIFICATON_IS_ACTUAL) THEN
               CALL MONTHLY_ACTUAL_VALUES(ANNUAL_ADDENDUM(1), &
               	MIDAS_MONTHLY_BOOKED,MIDAS_MONTHLY_DATA_UNITS,MONTH_ENDING, &
                                          ANNUAL_VALUE_STATUS)
            ELSE
               CALL MONTHLY_BOOK_VALUES_IN_DOLLARS(ANNUAL_ADDENDUM(1), &
               	MIDAS_MONTHLY_BOOKED,MIDAS_MONTHLY_DATA_UNITS,MONTH_ENDING)
            ENDIF
!
            SELECT CASE(trim(ADDENDUM_CLASSIFICATION))
...
!
        IF(INDEX(TRANSFER_CLASSIFICATION,'Plant Accumulated Depreciation') /= 0) &
         ...
         IF(.NOT. SAVE_BASE_CASE .AND. WVPA()) THEN
            IF(INDEX(ADDENDUM_CLASSIFICATION,'Sale/Removal') /= 0 .AND. &
            	INDEX(SALE_REMOVAL_CLASSIFICATION,'Net Removal') /= 0) THEN
            ...
            IF(IN_WVPA_DATA_BASE) THEN
               ...
               DO I = 1, FINANCIAL_SIMULATION_YEARS
                  ...
                  ENDIF
               ENDDO
               CALL WVPA_ADDENDUMS_DATA_BASE(ACCTNO,WVPA_COMPANY_ID, &
               DATA_BASE_CLASSIFICATION,ALLOC_EXPEN,FINANCIAL_SIMULATION_YEARS)
            ENDIF
         ENDIF
         IF(ASSET_CLASS_ID < 0.) THEN
            ...
            IF(ABS(ASSET_ALLOCATION_VECTOR) > 0) THEN
               CALL GET_ASSET_VAR(ABS(ASSET_ALLOCATION_VECTOR),DUMMY_TYPE, &
         ...
         DO
            ...
            IF(ASSET_ALLOCATION_LIST(CLASS_POINTER) < 0.) THEN
               ...
               DO I = 1, FINANCIAL_SIMULATION_YEARS
                  IF(I <= AVAIL_DATA_YEARS) ASSET_ALLOCATOR = &
            ...
            ALLOC_EXPEN(I,MO) = ASSET_ALLOCATOR * MIDAS_MONTHLY_BOOKED(MO,I)
                  ...
                  ELSE
                     ALLOC_EXPEN(I,0) = ADDENDUM(I) * ASSET_ALLOCATOR 
                     IF(I <= LAST_AVAILABLE_MONTHLY_YEAR .AND. &
                     	MONTHLY_MIDAS_ACTIVE) THEN
                        DO MO = 1, 12
                           ALLOC_EXPEN(I,MO) = ASSET_ALLOCATOR * &
...
!                        
            ...
            SELECT CASE(trim(ADDENDUM_CLASSIFICATION))
            CASE ('Payments')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN,&
                	PAYMENTS_CLASSIFICATION,PAYMENTS,FINANCIAL_SIMULATION_YEARS, &
                                         NUM_OF_ASSET_CLASSES)
            CASE ('Investments')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                	INVESTMENT_CLASSIFICATION,INVESTMENTS, &
                    FINANCIAL_SIMULATION_YEARS,NUM_OF_ASSET_CLASSES)
            CASE ('Fund Earnings','Interest Rates')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                	FUNDS_CLASSIFICATION,FUNDS_EARNINGS, &
                	FINANCIAL_SIMULATION_YEARS, &
                                         NUM_OF_ASSET_CLASSES)
            CASE ('Rate Base')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                	RATE_BASE_CLASSIFICATION,RATE_BASE,FINANCIAL_SIMULATION_YEARS, &
                                         NUM_OF_ASSET_CLASSES)
            CASE ('Working Capital','Inventories')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                WORKING_CAPITAL_CLASSIFICATION,WORKING_CAPITAL, &
                FINANCIAL_SIMULATION_YEARS,NUM_OF_ASSET_CLASSES)
            CASE ('CD/CIAC')
            ...
            CASE ('Sale/Removal of Assets','Sale/Removal')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                	SALE_REMOVAL_CLASSIFICATION,SALE_REMOVAL, &
                    FINANCIAL_SIMULATION_YEARS,NUM_OF_ASSET_CLASSES)
            CASE ('Shareholder Value')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                SHAREHOLDER_CLASSIFICATION,SHAREHOLDER_VALUE, &
                FINANCIAL_SIMULATION_YEARS,NUM_OF_ASSET_CLASSES)
            CASE ('Transfers')
               IF(WVPA() .AND. (INDEX(TRANSFER_CLASSIFICATION, &
               	'Depreciation Additions') /= 0))then

                  CALL WVPA_ADDENDUM_ACC(ASSET_CLASS,ALLOC_EXPEN, &
                  WVPA_ADDENDUM_ITEMS,FINANCIAL_SIMULATION_YEARS, &
                                        NUM_OF_ASSET_CLASSES)
               ELSE
                  CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                  	TRANSFER_CLASSIFICATION,TRANSFER_VALUE, &
                                            FINANCIAL_SIMULATION_YEARS, &
                                            NUM_OF_ASSET_CLASSES)
               ENDIF
            CASE ('Cash')
                CALL ADDENDUM_ACCUMULATION(ASSET_CLASS,ALLOC_EXPEN, &
                	TRANSFER_CLASSIFICATION,CASH_MONTHLY_VALUES, &
                                          FINANCIAL_SIMULATION_YEARS,NUM_OF_ASSET_CLASSES)
            CASE ('Actuals')
...
!
         IF(ALLOCATED(PAYMENTS)) DEALLOCATE(PAYMENTS, &
                                           ...
                                           ACTUAL_VALUE_FOUND, &
                                           OTHER_VALUE)
         ALLOCATE(PAYMENTS(0:12,0:FINANCIAL_SIMULATION_YEARS, &
         	-1:NUM_OF_ASSET_CLASSES,LAST_PAYMENT_ITEM), &
                 INVESTMENTS(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_INVESTMENT_ITEM), &
                 RATE_BASE(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_RATE_BASE_ITEM), &
                 WORKING_CAPITAL(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_WORKING_CAPITAL_ITEM), &
                 CD_CIAC(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_CD_CIAC_ITEM), &
                 SALE_REMOVAL(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_SALE_REMOVAL_ITEM), &
                 SHAREHOLDER_VALUE(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 	-1:NUM_OF_ASSET_CLASSES,LAST_SHAREHOLDER_VALUE_ITEM), &
                 TRANSFER_VALUE(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_TRANSFER_ITEM), &
                 CASH_MONTHLY_VALUES(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 	-1:NUM_OF_ASSET_CLASSES,LAST_CASH_TO_ITEMS), &
                 FUNDS_EARNINGS(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 	-1:NUM_OF_ASSET_CLASSES,LAST_EARNINGS_ITEM), &
                 OTHER_VALUE(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 	-1:NUM_OF_ASSET_CLASSES,LAST_OTHER_ITEM), &
                 ACTUAL_MONTHLY_VALUES(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_ACTUAL_ITEM), &
                 FASB143_ARO_VALUE(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_FASB_ITEM), &
                 CapX_Values(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_CAPX_ITEM),  &
                 WVPA_ADDENDUM_ITEMS(0:12,0:FINANCIAL_SIMULATION_YEARS, &
                 -1:NUM_OF_ASSET_CLASSES,LAST_CAPX_ITEM), &
...
!
         DO I = 0, R_FINANCIAL_SIMULATION_YEARS
               ...
               R_ADDENDUM_ARRAY(:,I,R_ASSET_CLASS,1) = &
               	R_ADDENDUM_ARRAY(:,I,R_ASSET_CLASS,1) +  &
               	R_ALLOC_EXPEN(I,:) ! DEPRECIATION
         ENDDO
      RETURN
            ...
            IF(.NOT.ACTUAL_VALUE_FOUND(R_ASSET_CLASS,ADDENDUM_TYPE))THEN
               DO I = 1, R_FINANCIAL_SIMULATION_YEARS
                  DO MO = 0, 12
                     ...
                     ENDIF
                     R_ADDENDUM_ARRAY(MO,I,R_ASSET_CLASS,ADDENDUM_TYPE)= &
                     	R_ADDENDUM_ARRAY(MO,I,R_ASSET_CLASS,ADDENDUM_TYPE) &
                     +  R_ALLOC_EXPEN(I,MO)
                  ENDDO
               ENDDO
...
!
         IF(ALLOCATED(PAYMENTS)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               ENDIF
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
                  R_DECOMMISSIONING_FUND = R_DECOMMISSIONING_FUND + &
                  	PAYMENTS(0,YR,ASSET_CLASS,1)
      ...
      ENTRY RETURN_BAL_SHEET_LIAB_PAYMENTS(R_YR,R_CLASS, &
      	R_PENSION_EXPENSE_CASH,R_STORM_EXPENSE_CASH,R_VACATION_PAY_CASH)
...
! Merge2issue: (probably ok) Left side used R_MO_NucDecom_Interest_Accretion, 
! right side used R_MO_NucDecom_Int_Accretion. Going with right
! side choice.
         ...
         IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
            ...
            IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
! Merge2issue:  Left side used R_MO_NucDecom_Interest_Accretion and
! right side used R_MO_NucDecom_Int_Accretion. Going with
! right side choice.
               IF(ALLOCATED(FASB143_ARO_VALUE)) THEN
...
!
         ...
         IF(R_CLASS <= MAX_ASSET_CLASS_NUM .AND. &
         	ALLOCATED(FASB143_ARO_VALUE)) THEN
            YR = R_YR
            IF(R_CLASS == 0) THEN
               ASSET_CLASS = 0
            ELSE
...
! Merge2Issue: (problably ok) Left side used CASH_TO_ACCRUED_MEMBER_REVENUES_BAL and 
! right side used CASH_TO_ACCRD_MBR_REVENUES_BAL. Going with right-side
! choice.
      ENTRY RETURN_CASH_TRANSFERS(R_CLASS,R_YR,CASH_TO_CASH, &
      CASH_TO_POST_RETIRE_MEDICAL_BAL,CASH_TO_ACCRD_MBR_REVENUES_BAL)

!
         CASH_TO_CASH = 0.
         CASH_TO_POST_RETIRE_MEDICAL_BAL = 0.
         IF(R_CLASS <= MAX_ASSET_CLASS_NUM .AND. &
         	ALLOCATED(CASH_MONTHLY_VALUES)) THEN
            YR = R_YR
            IF(R_CLASS == 0) THEN
               ASSET_CLASS = 0
            ELSE
            ...
            IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
               CASH_TO_CASH = &
               	CASH_MONTHLY_VALUES(0,YR,ASSET_CLASS,1)  ! cash_2_cash
               CASH_TO_POST_RETIRE_MEDICAL_BAL = &
               	CASH_MONTHLY_VALUES(0,YR,ASSET_CLASS,2)    ! Cash to Post Retirement Fund
               CASH_TO_ACCRD_MBR_REVENUES_BAL = &
               	CASH_MONTHLY_VALUES(0,YR,ASSET_CLASS,3)    ! Cash to Accrued Member Revenue
            ENDIF
         ENDIF
      RETURN
            ...
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,5) /= 0.) then
                  	R_STD_RATE = FUNDS_EARNINGS(0,YR,ASSET_CLASS,5)/100. ! STD Rate
                  end if
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,6) /= 0.) then
                  	 R_NUCL_DECOM_FUND_RETURN = FUNDS_EARNINGS(0,YR,ASSET_CLASS,6)/100.
                  end if
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,7) /= 0.) then
                  	 R_RETURN_RETIREMENT_FUND = FUNDS_EARNINGS(0,YR,ASSET_CLASS,7)/100.
                  end if
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,8) /= 0.) then
                  	R_RETURN_ON_ST_INVEST = FUNDS_EARNINGS(0,YR,ASSET_CLASS,8)/100.
                  end if
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,9) /= 0.) then
                  	 R_RETURN_ON_LTI = FUNDS_EARNINGS(0,YR,ASSET_CLASS,9)/100.
                  end if
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,10) /= 0.) then
                  	R_INTEREST_ON_CUSTOMER_DEPOSITS = &
                               FUNDS_EARNINGS(0,YR,ASSET_CLASS,10)/100.
                  end if
                  
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,11) /= 0.) then
                  	R_OCI_RETURN_RETIREMENT_FUND = &
                    FUNDS_EARNINGS(0,YR,ASSET_CLASS,11)/100.
                  end if
                  IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,12) /= 0.) then
                  	R_OCI_NUCL_DECOM_FUND_RETURN = &
...
!
         IF(ALLOCATED(FUNDS_EARNINGS)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
                     ...
                     ENDIF
                     IF(FUNDS_EARNINGS(0,YR,ASSET_CLASS,10) /= 0.) THEN
                        R_MONTHLY_CUST_DEPOSITS_RATE(:) =  &
                        	FUNDS_EARNINGS(:,YR,ASSET_CLASS,10)
                     ELSE
                        CALL RET_MTHLY_CUSTOMER_VECTOR_RATES( &
                        	RATE_FOUND,R_MONTHLY_CUST_DEPOSITS_RATE)
                        IF(.NOT. RATE_FOUND) then
                        	R_MONTHLY_CUST_DEPOSITS_RATE(:) = &
                        		100.*R_INTEREST_ON_CUSTOMER_DEPOSITS 
                        end if
                     ENDIF
               ...
               DO MO = 0, 12
                  ...
                  R_MONTHLY_NUC_DECOM_RATE(MO) = &
                  	R_MONTHLY_NUC_DECOM_RATE(MO)/D12 
                  R_MONTHLY_RETIREMENT_FUND_RATE(MO) = &
                  	R_MONTHLY_RETIREMENT_FUND_RATE(MO)/D12 
                  R_MONTHLY_STI_RATE(MO) = R_MONTHLY_STI_RATE(MO)/D12 
                  R_MONTHLY_LTI_RATE(MO) = R_MONTHLY_LTI_RATE(MO)/D12 
                  R_MONTHLY_CUST_DEPOSITS_RATE(MO) = &
                  	R_MONTHLY_CUST_DEPOSITS_RATE(MO)/D12
                  D12 = 1200.
               ENDDO
            ELSE
               D12 = 1.
      ...
      ENTRY RET_MTHLY_FUNDS_EARNING_RATES(R_YR,R_CLASS, &
      	R_INTEREST_ON_CUSTOMER_DEPOSITS,R_RETURN_RETIREMENT_FUND, &
        R_NUCL_DECOM_FUND_RETURN,R_MONTHLY_CUST_DEPOSITS_RATE, &
        R_MONTHLY_RETIREMENT_FUND_RATE, &
        OCI_MTHLY_RETIREMENT_FUND_RATE,R_MONTHLY_NUC_DECOM_RATE, &
         ...
         IF(ALLOCATED(CD_CIAC)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
                  ...
                  R_CIAC_ADDENDUM_TO_AMORTIZATION = &
                  	R_CIAC_ADDENDUM_TO_AMORTIZATION  + CD_CIAC(0,YR,ASSET_CLASS,5)
               ENDIF
            ENDIF
         ENDIF
      RETURN
...
!
         ...
         IF(ALLOCATED(SALE_REMOVAL)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               ENDIF
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
                  R_NET_REMOVAL = R_NET_REMOVAL - &
                  	(SALE_REMOVAL(0,YR,ASSET_CLASS,1) + &
                  	SALE_REMOVAL(0,YR,ASSET_CLASS,8) - & ! Cost of Removal
                  SALE_REMOVAL(0,YR,ASSET_CLASS,9)) ! Salvage Value
                  R_CASH_RECEIVED = R_CASH_RECEIVED +  &
                  SALE_REMOVAL(0,YR,ASSET_CLASS,2)
...
!
      ...
      ENTRY RETURN_TRANSFER_ADDENDUMS(R_YR,R_CLASS,R_GROSS_PLANT_VALUE, &
      R_CUMULATED_PLANT_DEPRECIATION,R_DEFERRED_TAXES_BAL_ADJ, &
      R_DEFERRED_DEBIT_ADJUSTMENT,R_NET_DEFERRED_DEBIT_ADJUSTMENT, &
      R_ATL_DEBIT_AMORTIZATION, &
      R_BTL_DEBT_AMORTIZATION,R_ANNUAL_DEFERRED_TAXES,R_DEFERRED_ITCS_BAL_ADJ, &
      R_NET_NUCLEAR_FUEL_ADJ,R_RETAINED_EARNINGS_ADJ,R_EXTRA_ORDINARY_EXPENSE, &
      R_LT_LIAB_BAL_ADJ, &
      R_CWIP_BALANCE_ADJ,R_DEFERRED_TAXES_DR,R_PAID_IN_CAPITAL, &
      R_SUBSIDIARY_INVESTMENT_ADJ, &
      R_GOODWILL_ADJUSTMENT,R_REG_ASSESTS_ADJUSTMENT,R_FASB109_ADJUSTMENT, &
      R_FASB133_ADJUSTMENT, &
      R_UNAMORT_INTEREST_ADJUSTMENT,R_NUCLEAR_DECOM_FUND_BAL,R_CAP_LEASES_BAL, &
      R_ASSETS_NEC_BAL, &
      R_PREFERRED_STOCK_BAL,R_LTD_BAL,R_STD_BAL,R_NUC_DECOM_LIAB_BAL, &
      R_LIABS_NEC_BAL, &
      R_OTHER_INVESTMENT_BAL,R_NOTES_RECEIVABLE_BAL,R_POST_RETIRE_MEDICAL_BAL, &
      R_DEFERRED_REVENUES_BAL,R_DEFERRED_FUEL_BAL,R_DEFERRED_PURCH_GAS_BAL, &
      R_LT_INVEST_BAL, &
      R_ST_INVEST_BAL,R_FUEL_INVENTORY_BAL,R_GAS_IN_STORAGE_BAL, &
      R_MATRIAL_SUPPLY_BAL, &
      R_ACCOUNTS_RECV_BAL,R_UNBILLED_REV_BAL,R_TAXES_RECEIVABLE_BAL, &
      R_CURRENT_LT_DEBT_BAL, &
      R_NOTES_PAYABLE_BAL,R_CUSTOMER_DEPOSIT_BAL,R_CICA_BAL, &
      R_POST_RETIRE_PAYABLE_BAL, &
      R_ACCRUED_PENSION_BAL,R_DEFERRED_GAINS_BAL,R_STROM_RESERVE_BAL, &
      R_ACCOUNTS_PAYABLE_BAL, &
      R_ARO_NET_ASSETS,R_ARO_LIABILITY,R_DEFERRED_PURCHASE_POWER_ADJ, &
      R_COI_EARNINGS)
...
!
         IF(ALLOCATED(TRANSFER_VALUE)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               ENDIF
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
                  R_GROSS_PLANT_VALUE = R_GROSS_PLANT_VALUE - &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,1)
                  R_CUMULATED_PLANT_DEPRECIATION =  &
                  R_CUMULATED_PLANT_DEPRECIATION -  &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,2)
                  R_DEFERRED_TAXES_BAL_ADJ = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,3)
                  R_DEFERRED_DEBIT_ADJUSTMENT = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,4)
                  R_ATL_DEBIT_AMORTIZATION = R_ATL_DEBIT_AMORTIZATION -  &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,5)
                  R_BTL_DEBT_AMORTIZATION = R_BTL_DEBT_AMORTIZATION - &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,6)
                  R_ANNUAL_DEFERRED_TAXES = R_ANNUAL_DEFERRED_TAXES + &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,7)
                  R_NET_DEFERRED_DEBIT_ADJUSTMENT = TRANSFER_VALUE(0,YR, &
                  	ASSET_CLASS,4) - TRANSFER_VALUE(0,YR,ASSET_CLASS,5) &
                                   - TRANSFER_VALUE(0,YR,ASSET_CLASS,6)
                  R_DEFERRED_ITCS_BAL_ADJ = TRANSFER_VALUE(0,YR,ASSET_CLASS,8)
                  R_NET_NUCLEAR_FUEL_ADJ = R_NET_NUCLEAR_FUEL_ADJ + &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,9)
                  R_RETAINED_EARNINGS_ADJ = R_RETAINED_EARNINGS_ADJ + &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,10)
                  R_EXTRA_ORDINARY_EXPENSE = R_EXTRA_ORDINARY_EXPENSE + &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,11)
                  R_LT_LIAB_BAL_ADJ = R_LT_LIAB_BAL_ADJ + &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,12)
                  R_CWIP_BALANCE_ADJ = R_CWIP_BALANCE_ADJ + &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,13)
                  R_DEFERRED_TAXES_DR = R_DEFERRED_TAXES_DR + &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,14)
                  R_PAID_IN_CAPITAL = TRANSFER_VALUE(0,YR,ASSET_CLASS,15)
                  R_SUBSIDIARY_INVESTMENT_ADJ = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,16)
                  R_GOODWILL_ADJUSTMENT = TRANSFER_VALUE(0,YR,ASSET_CLASS,17) ! Goodwill
                  R_REG_ASSESTS_ADJUSTMENT = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,18) ! Regulatory Assets
                  R_FASB109_ADJUSTMENT = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,19) ! FASB 109
                  R_FASB133_ADJUSTMENT = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,21) ! FASB 133
                  R_UNAMORT_INTEREST_ADJUSTMENT = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,22) ! Unamortizated Interest
                  R_NUCLEAR_DECOM_FUND_BAL = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,25) ! Nuc Decom Trust Fund
                  R_POST_RETIRE_MEDICAL_BAL = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,26) ! Post Retirement Medical Bal
                  ...
                  R_ASSETS_NEC_BAL = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,39) ! assets NEC
                  R_PREFERRED_STOCK_BAL = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,40) ! Preferred Stock Bal
                  R_LTD_BAL = TRANSFER_VALUE(0,YR,ASSET_CLASS,41)        ! Long Term Debt Bal
                  R_NUC_DECOM_LIAB_BAL = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,44) ! Nuc Decom Liab
                  R_ACCRUED_PENSION_BAL = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,49)
                  ...
                  R_DEFERRED_PURCHASE_POWER_ADJ = &
                  	TRANSFER_VALUE(0,YR,ASSET_CLASS,59)
                  IF(MONTHLY_MIDAS_ACTIVE) THEN ! ADDED TO KEEP THE ANNUAL AS A ONE YEAR ADJUSTMENT
                     DO YR = 1, R_YR-1
                        R_CWIP_BALANCE_ADJ = R_CWIP_BALANCE_ADJ + &
                        	TRANSFER_VALUE(0,YR,ASSET_CLASS,13) ! CWIP ADJUSTMENTS
      ...
      ENTRY RETURN_MONTHLY_IPL_ELECT_PLAN(R_YR,R_CLASS, &
      	IPL_ELECTRIC_PLAN_FUEL_COSTS,IPL_ELECTRIC_PLAN_PUR_COSTS)
            ...
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN 
                  IPL_ELECTRIC_PLAN_FUEL_COSTS(:) = &
                  	IPL_ELECTRIC_PLAN_FUEL_COSTS(:) + &
                  		OTHER_VALUE(:,YR,ASSET_CLASS,4)
                                                                                                                   ! ElectPlan Fuel)
                  IPL_ELECTRIC_PLAN_PUR_COSTS(:) = &
                  	IPL_ELECTRIC_PLAN_PUR_COSTS(:) + &
                  		OTHER_VALUE(:,YR,ASSET_CLASS,5) !ElectPlan Pur)
               ENDIF
            ENDIF
         ENDIF
      RETURN
...
!
         ...
         IF(ALLOCATED(OTHER_VALUE)) THEN
            ...
            DO ASSET_CLASS = 1, NUM_OF_ASSET_CLASSES
               R_SRP_TARGET_SALES = R_SRP_TARGET_SALES + &
               	OTHER_VALUE(0,YR,ASSET_CLASS,SRP_Target_Sales)
            ENDDO
         ENDIF
      RETURN

      ENTRY RETURN_GRE_DSC_ADJUSTMENTS(R_YR, &
      	R_GRE_INT_PAYMENTS_MANUAL_ADJS,R_GRE_PRINCIPAL_MANUAL_ADJS)
...
!
         ...
         IF(ALLOCATED(OTHER_VALUE)) THEN
            YR = R_YR
            DO ASSET_CLASS = 1, NUM_OF_ASSET_CLASSES
               R_GRE_PRINCIPAL_MANUAL_ADJS = OTHER_VALUE(0,YR,ASSET_CLASS, &
               GRE_DSC_Principal_Pay_Adj)
               R_GRE_INT_PAYMENTS_MANUAL_ADJS = OTHER_VALUE(0,YR,ASSET_CLASS, &
               GRE_DSC_Interest_Pay_Adj)
            ENDDO
         ENDIF
      RETURN

      ENTRY RET_MTHLY_NUC_DECOM_CASH_ADDENS(R_CLASS,R_YR, &
      	R_MONTHLY_NUC_DECOM_CASH_VALUES,R_MTHLY_NUC_DECOM_EARNGS_ADDEM)
! Merge2issue: (probably ok) Left side using R_MONTHLY_NUC_DECOM_EARNINGS_ADDEM,
! Right side using R_MTHLY_NUC_DECOM_EARNGS_ADDEM. Used chosen
! right-side value.
...
!
         IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
            ...
            IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN
               IF(ALLOCATED(PAYMENTS)) then
               		R_MONTHLY_NUC_DECOM_CASH_VALUES = &
               		PAYMENTS(:,R_YR,ASSET_CLASS,1)
               end if
               IF(ALLOCATED(FUNDS_EARNINGS)) then
               	R_MTHLY_NUC_DECOM_EARNGS_ADDEM = &
               	FUNDS_EARNINGS(:,R_YR,ASSET_CLASS,1)
               end if
            ENDIF
         ENDIF
      RETURN

      ENTRY RET_MTHLY_RETIRMENT_CASH_ADDENS(R_CLASS,R_YR, &
      R_MTHLY_POST_RETIRMT_CASH_PAYMS, &
...
!
         IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
            ...
            IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN
               IF(ALLOCATED(PAYMENTS)) THEN 
                  R_MTHLY_POST_RETIRMT_CASH_PAYMS = &
                  	PAYMENTS(:,R_YR,ASSET_CLASS,3)
                  R_MTHLY_RETIREE_MED_CASH_PAYMTS = &
                  	PAYMENTS(:,R_YR,ASSET_CLASS,4)
               ENDIF
               IF(ALLOCATED(FUNDS_EARNINGS)) then
	               	R_MTHLY_RETRMNT_FUND_EARNGS_ADJ = &
	               		FUNDS_EARNINGS(:,R_YR,ASSET_CLASS,2)
               end if
               IF(ALLOCATED(CASH_MONTHLY_VALUES)) THEN
  
                   MONTHLY_CASH_TO_POST_RETIREMENT = &
                   	CASH_MONTHLY_VALUES(:,YR,ASSET_CLASS,2) 
               ENDIF
            ENDIF
         ENDIF
      RETURN

      ENTRY RETURN_MONTHLY_CASH_ADDENDUMS(R_CLASS,R_YR,&
      	R_CASH_VALUES,R_INCOME_VALUES)
...
!
         IF(ALLOCATED(INVESTMENTS)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN
                  DO MO = 0, 12
                     R_CASH_VALUES(MO,cash_subsidiary_dividends) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,1)
                     R_CASH_VALUES(MO,cash_equity_to_subsidiaries) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,3)
                     R_CASH_VALUES(MO,cash_net_investments) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,4)
                     R_CASH_VALUES(MO,cash_capital_leases) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,5)
                     R_CASH_VALUES(MO,cash_lease_receipts) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,5)
                     R_CASH_VALUES(MO,cash_from_assets_sale) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,6) + &
                     		SALE_REMOVAL(MO,YR,ASSET_CLASS,2)
                     R_CASH_VALUES(MO,cash_change_ltinvestments) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,7)
                     R_CASH_VALUES(MO,cash_net_salvage) = &
                     	-(SALE_REMOVAL(MO,YR,ASSET_CLASS,1) &
                     + SALE_REMOVAL(MO,YR,ASSET_CLASS,8)  & ! Cost of Removal
                     - SALE_REMOVAL(MO,YR,ASSET_CLASS,9))   ! Salvage Value
                     R_CASH_VALUES(MO,class_net_invest_slvg_othr) = &
                     	R_CASH_VALUES(MO,cash_net_investments) &
                                 + R_CASH_VALUES(MO,cash_net_salvage) + &
                                 R_CASH_VALUES(MO,cash_net_other)
                     R_CASH_VALUES(MO,cash_ciac) = CD_CIAC(MO,YR,ASSET_CLASS,3)

                     R_CASH_VALUES(MO,cash_customer_deposits) = &
                     	CD_CIAC(MO,YR,ASSET_CLASS,2)
                     R_CASH_VALUES(MO,cash_fuel_inventory_chg) = &
                     	WORKING_CAPITAL(MO,YR,ASSET_CLASS,3)
                     R_CASH_VALUES(MO,class_matrls_inventry_addition) = &
                     	WORKING_CAPITAL(MO,YR,ASSET_CLASS,4)
                     R_CASH_VALUES(MO,cash_gas_strg_inventry_addtn) = &
                     	WORKING_CAPITAL(MO,YR,ASSET_CLASS,5)
                     R_CASH_VALUES(MO,cash_nuc_decommissioning_fund) =  &
                     	PAYMENTS(MO,YR,ASSET_CLASS,1)
                     R_CASH_VALUES(MO,Cash_Post_Retirement_Payments) = &
                     	PAYMENTS(MO,YR,ASSET_CLASS,3)
                     R_CASH_VALUES(MO,wvpa_cash_2_accrd_mbr_revnue) = &
                     	CASH_MONTHLY_VALUES(MO,YR,ASSET_CLASS,3)
                                                                                                        ! CASH TO ACCRUED MEMBER BAL
                     R_CASH_VALUES(MO,csh_2_post_retiremt_paymentss) = &
                     	CASH_MONTHLY_VALUES(MO,YR,ASSET_CLASS,2) 
                                                                                                       ! CASH TO RETIREMENT PAYMENTS
                     R_CASH_VAlues(MO,cash_2_cash) = &
                     	CASH_MONTHLY_VALUES(MO,YR,ASSET_CLASS,1) ! cash_2_cash
                     R_CASH_VALUES(MO,Cash_Retiree_Medical_Payments) = &
                     	PAYMENTS(MO,YR,ASSET_CLASS,4)
                     R_CASH_VALUES(MO,csh_unfundd_retrmt_pymts) = &
                     	R_CASH_VALUES(MO,csh_unfundd_retrmt_pymts) &
                                 + PAYMENTS(MO,YR,ASSET_CLASS,6)
                     R_CASH_VALUES(MO,Cash_Storm_Payments) = &
                     	R_CASH_VALUES(MO,Cash_Storm_Payments) + &
                     		PAYMENTS(MO,YR,ASSET_CLASS,7)
                     R_CASH_VALUES(MO,Cash_Vacation_Payments) = &
                     	R_CASH_VALUES(MO,Cash_Vacation_Payments) &
...
! INCOME ITEMS
!
                     R_INCOME_VALUES(MO,Monthly_Subsidiary_Income) = &
                     	INVESTMENTS(MO,YR,ASSET_CLASS,2)
                     R_INCOME_VALUES(MO,Monthly_Retirement_Expense) = &
                     	PAYMENTS(MO,YR,ASSET_CLASS,3)
                     R_INCOME_VALUES(MO,Monthly_Amortization) = &
                     	R_INCOME_VALUES(MO,Monthly_Amortization) &
                               + TRANSFER_VALUE(MO,YR,ASSET_CLASS,5)
                     R_INCOME_VALUES(MO,BTL_Monthly_Amortization) = &
                     	R_INCOME_VALUES(MO,BTL_Monthly_Amortization) &
                               + TRANSFER_VALUE(MO,YR,ASSET_CLASS,6)
                     R_INCOME_VALUES(MO,Monthly_Fossil_Fuel) = &
                     	R_INCOME_VALUES(MO,Monthly_Fossil_Fuel) &
                               + WORKING_CAPITAL(MO,YR,ASSET_CLASS,12)
                                 ! FUEL INVENTORY AMORTIZATION
                     R_INCOME_VALUES(MO,monthly_other_oandm) = &
                     	R_INCOME_VALUES(MO,monthly_other_oandm) &
                               + WORKING_CAPITAL(MO,YR,ASSET_CLASS,13)   ! M&S AMORTIZATION
                     R_INCOME_VALUES(MO,monthly_purchased_gas) = &
                     	R_INCOME_VALUES(MO,monthly_purchased_gas) &
                               + WORKING_CAPITAL(MO,YR,ASSET_CLASS,14)   ! GAS STORAGE AMORTIZATION
                     R_INCOME_VALUES(MO,monthly_fuel_inventory_amort) = &
                     	WORKING_CAPITAL(MO,YR,ASSET_CLASS,12)
                     ! FUEL INVENTORY AMORTIZATION
                     R_INCOME_VALUES(MO,mnth_mtl_and_supplys_amort) = &
                     	WORKING_CAPITAL(MO,YR,ASSET_CLASS,13)   ! M&S AMORTIZATION
                     R_INCOME_VALUES(MO,monthly_gas_storage_amort) = &
                     	WORKING_CAPITAL(MO,YR,ASSET_CLASS,14)   
      ...
      ENTRY MONTHLY_WORKING_CAPITAL_ADJ(R_YR,R_CLASS,R_ASSET_NEC_ADDENDUM, &
      	R_LIABS_NEC_ADDENDUM)
...
!
         ...
         IF(ALLOCATED(WORKING_CAPITAL)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               ENDIF
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN
                  R_ASSET_NEC_ADDENDUM(12) = &
                  	WORKING_CAPITAL(0,R_YR,ASSET_CLASS,1)
                  R_LIABS_NEC_ADDENDUM(12) = &
                  	WORKING_CAPITAL(0,R_YR,ASSET_CLASS,2)
                  DO MO = 1, 11
                     R_ASSET_NEC_ADDENDUM(MO) = &
                     	WORKING_CAPITAL(MO,R_YR,ASSET_CLASS,1)
                     R_LIABS_NEC_ADDENDUM(MO) = &
                     	WORKING_CAPITAL(MO,R_YR,ASSET_CLASS,2)
                  ENDDO
               ENDIF
            ENDIF
         ENDIF
      ...
      ENTRY RETURN_MONTHLY_BAL_ADDENDUMS(R_YR,R_CLASS,R_BALANCE_SHEET_VALUES, &
      	R_TRANSFER_VARIABLES,R_DEFERRED_GAIN_ADJ)
...
!
         ...
         IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
            ...
            IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN
               ...
               IF(ALLOCATED(TRANSFER_VALUE)) THEN
                  DO YR = 1, R_YR-1
                     GPV_ADJUSTMENT = GPV_ADJUSTMENT + &
                     TRANSFER_VALUE(0,YR,ASSET_CLASS,1)
                     DEF_TAX_ADJUSTMENT = DEF_TAX_ADJUSTMENT + &
                     TRANSFER_VALUE(0,YR,ASSET_CLASS,3)
                     DEF_DEBIT_ADJUSTMENT = DEF_DEBIT_ADJUSTMENT + &
                     TRANSFER_VALUE(0,YR,ASSET_CLASS,4) &
                      - TRANSFER_VALUE(0,YR,ASSET_CLASS,5) - &
                      TRANSFER_VALUE(0,YR,ASSET_CLASS,6)
               ...
               DO MO = 1, 12
                  IF(ALLOCATED(TRANSFER_VALUE)) THEN
                     GPV_ADJUSTMENT = GPV_ADJUSTMENT + &
                     	TRANSFER_VALUE(MO,YR,ASSET_CLASS,1)
                     DEF_TAX_ADJUSTMENT = DEF_TAX_ADJUSTMENT + &
                     	TRANSFER_VALUE(MO,YR,ASSET_CLASS,3)
                     DEF_DEBIT_ADJUSTMENT = DEF_DEBIT_ADJUSTMENT + &
                     	TRANSFER_VALUE(MO,YR,ASSET_CLASS,4) &
                                  - TRANSFER_VALUE(MO,YR,ASSET_CLASS,5) - &
                                  TRANSFER_VALUE(MO,YR,ASSET_CLASS,6)
                     R_BALANCE_SHEET_VALUES(MO,monthly_net_dfrd_debits) = &
                     	R_BALANCE_SHEET_VALUES(MO,monthly_net_dfrd_debits) &
                            + DEF_DEBIT_ADJUSTMENT
                     CWIP_BALANCE_ADJ = CWIP_BALANCE_ADJ + &
                     TRANSFER_VALUE(MO,YR,ASSET_CLASS,13) ! CWIP ADJUSTMENTS
                     LT_LIAB_BAL_ADJ = LT_LIAB_BAL_ADJ + &
                     	TRANSFER_VALUE(MO,YR,ASSET_CLASS,12)
                     NET_NUC_FUEL_ADJ = NET_NUC_FUEL_ADJ +  &
                     	TRANSFER_VALUE(MO,YR,ASSET_CLASS,9) ! NET NUCLEAR FUEL
                     CAPITAL_LEASE_ADJ = CAPITAL_LEASE_ADJ + &
                     	TRANSFER_VALUE(MO,YR,ASSET_CLASS,55) ! CAPITAL LEASE ADJ
                  ENDIF
                  IF(ALLOCATED(SALE_REMOVAL)) THEN
                     GPV_ADJUSTMENT = GPV_ADJUSTMENT - &
                     	SALE_REMOVAL(MO,YR,ASSET_CLASS,3)
                     DEF_TAX_ADJUSTMENT = DEF_TAX_ADJUSTMENT - &
                     	SALE_REMOVAL(MO,YR,ASSET_CLASS,5)
                  ENDIF
                  R_BALANCE_SHEET_VALUES(MO, &
                  	monthly_gross_plant_in_svc) = &
                  	R_BALANCE_SHEET_VALUES(MO,monthly_gross_plant_in_svc) &
                                    + GPV_ADJUSTMENT
                  R_BALANCE_SHEET_VALUES(MO,monthly_acc_dep_adjs) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,2) &
                                    - SALE_REMOVAL(MO,YR,ASSET_CLASS,4)
                  R_BALANCE_SHEET_VALUES(MO,mty_dfrd_income_taxes)= &
                  	R_BALANCE_SHEET_VALUES(MO,mty_dfrd_income_taxes) &
                                    + DEF_TAX_ADJUSTMENT

                  R_TRANSFER_VARIABLES(MO,mtly_cwip)=&
                  	CWIP_BALANCE_ADJ ! CWIP ADJUSTMENTS
                  R_TRANSFER_VARIABLES(MO,monthly_net_nuclear_fuel) = &
                  	NET_NUC_FUEL_ADJ
                  R_TRANSFER_VARIABLES(MO,monthly_capitalized_leases) = &
                  	CAPITAL_LEASE_ADJ
                  R_TRANSFER_VARIABLES(MO,monthly_other_long_term_liabs) = &
                  	LT_LIAB_BAL_ADJ
                  R_TRANSFER_VARIABLES(MO,monthly_net_goodwill) = &
                  	R_TRANSFER_VARIABLES(MO,monthly_net_goodwill) &
                     + TRANSFER_VALUE(MO,YR,ASSET_CLASS,17) ! Goodwill
               ENDDO
               IF(ALLOCATED(TRANSFER_VALUE)) THEN
                  MO = 1
                  R_TRANSFER_VARIABLES(MO,monthly_common_stock) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,15)
                  R_TRANSFER_VARIABLES(MO,mthly_coi_retained_earnings_bal) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,58) 
                  R_TRANSFER_VARIABLES(MO,monthly_retained_earnings_bal) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,10)
                  R_TRANSFER_VARIABLES(MO,monthly_preferred_stock) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,40)
                  R_TRANSFER_VARIABLES(MO,monthly_long_term_debt) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,41)
                  R_TRANSFER_VARIABLES(MO,monthly_short_term_debt_bal) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,31)
                  R_TRANSFER_VARIABLES(MO,mthly_nucl_decommiss_liability) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,44)
                  R_TRANSFER_VARIABLES(MO,monthly_liabilities_nec) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,54)
                  R_TRANSFER_VARIABLES(MO,monthly_nclr_dcms_trust_bal) = &
                  	TRANSFER_VALUE(MO,YR,ASSET_CLASS,25)

                  DO MO= 2, 12
                     R_TRANSFER_VARIABLES(MO,monthly_common_stock) = &
                     	R_TRANSFER_VARIABLES(MO,monthly_common_stock) &
                           + TRANSFER_VALUE(MO,YR,ASSET_CLASS,15)
                     R_TRANSFER_VARIABLES(MO, &
                     	mthly_coi_retained_earnings_bal) = &
                     	R_TRANSFER_VARIABLES(MO, &
! Merge2issue: (probably ok) Left side used monthly_coi_retained_earnings_bal, while
! right side used mthly_coi_retained_earnings_bal. Going with
! right-side choice.
                        mthly_coi_retained_earnings_bal) + &
                        TRANSFER_VALUE(MO,YR,ASSET_CLASS,58)
                     R_TRANSFER_VARIABLES(MO,monthly_retained_earnings_bal) = &
...
!
         IF(ALLOCATED(SALE_REMOVAL)) THEN
            IF(R_CLASS <= MAX_ASSET_CLASS_NUM) THEN
               ...
               IF(ASSET_CLASS > 0 .OR. R_CLASS == 0) THEN
                  DO MO = 0, 12
                     R_INCOME_VALUES(MO,Monthly_ATL_Gain_Amort) = &
                     	SALE_REMOVAL(MO,YR,ASSET_CLASS,6)
                     R_INCOME_VALUES(MO,Monthly_BTL_Gain_Amort) = &
                     	SALE_REMOVAL(MO,YR,ASSET_CLASS,7)
                  ENDDO
               ENDIF
            ENDIF
         ENDIF
      ...
      ENTRY MONTHLY_ADDENDUM_CIAC_VALUES(R_CLASS,R_YR,R_CIAC_MONTHLY_AMORT_RATE, &
      	R_CIAC_MONTHLY_ADDENDUM_2_AMORT, &
        R_CIAC_MONTHLY_CASH)
...
!
         ...
         CASE ('Other Investments')
            ADDENDUM_POSITION = 4
         CASE ('Capitialized Lease Additions', &
