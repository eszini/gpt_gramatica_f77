...
C***********************************************************************
C
      RECURSIVE SUBROUTINE FINDOVLS(OVLNAME,MATCH_FOUND,endpoint_ord,
     +                              RUN_FUTURE_ASSETS)
C
      USE ProSymModule
      use end_routine
...
!       Coal Model Generic Units operation data for generic units 375
!       Coal Model Transportation Links for Generic Units
!       Coal Model SO2 & Scruber Info ! 373
!       COAL_MODEL_POINTER_FILE      ! 372  
! Vector file for coal price model
!       GQB GAS THERMAL 353
!       COAL NODES 354
!       COAL LINKS 355
!       COAL SUPPLY 356
!       COAL DEMAND US 357
!       COAL DEMAND CANADA 358
!       169 10/10/01 174 11/1/01 175 11/26/01, 185 TMS 04/15/02, 
! 185 GAT
!       4/26/02, 187 tms 5/13/02 188 12/23/02 189 MSG 1/14/03 190-193 
! MSG MAY '03
!       194-196 06/12/03 197 07/17/03 200 10/23/03
!       201-204 ADDED FOR NEW ENERGY PRODUCTS FILES TO PUT THE NUMBER 
! AT 5
!       205-210 ADDED FOR DB TO EXPAND THE NUMBER OF THERMAL UNIT FILES
! MSG 7/15/05
!       211-213 ADDED FOR CAPEX RESULTS MSG 8/3/05
!       304-306 ADDED BY AT FOR CUSTOM LHC FILES
!       307-312 ADDED BY DR.G FOR MRX RESOURCE RESULTS.
!       313-316 ADDED BY DR.G FOR ADDITIONAL ESCALATION FILES
!       317-320 ADDED BY DR.G FOR ADDITIONAL VARIABLE UNIT PARAMETER 
! FILES
!       321-331 ADDED BY GREG FOR WORLD LNG ANALYTIC
!       332     ADDED BY GREG FOR ADVANCED PRICE FORMATION
!       333     ADDED BY GREG FOR GAS PIPELINE MODELING. 070909.
!       334     ADDED BY GREG FOR GAS STORAGE. 070909.
! NOTE THAT FILE NUMBER 7 IS USED FOR EXPENSE AND REVENUE NAMES BUT 
! IS NOT "OVERLAYABLE" 11/27/01 MSG
      LOGICAL*1 RUN_FUTURE_ASSETS,
     +          CLASS_BASED_FORECAST,WVPA
C
      LOGICAL*1 OVERLAY_BOOK_ACTIVE,
     +          OVERLAY_BOOK_IS_ACTIVE
      LOGICAL*4 BIN_FILE_EXISTS,THIS_FILE_EXISTS
      INTEGER*2 J
      CHARACTER*1 UTILITY_TYPE
      CHARACTER*5 OVLNAME,R_OVLNAME
      CHARACTER*256 SAVED_OVLNAME

      CHARACTER*256 FILE_IN,FILE_SEARCH,OUTPUT_DIRECTORY
      INTEGER*2 I,endpoint_ord,RETURN_CODE,ISERROR
      CHARACTER*(*) R_PROJECT_NAME
      LOGICAL*1 R_MATCH_FOUND,R_FILE_EXISTS(*)
      INTEGER*2 DELETE,FAMILY_POSITION,NUMBER_OF_DEFINITIONS
      INTEGER IOS
      LOGICAL*1 FAMILY_DEFINITION_EXISTS,RUN_COAL_MODEL_ONLY
      LOGICAL*1 OVERLAY_FILE_EXISTS(:,:),OVERLAY_FAMILY_ACTIVE(:)
      CHARACTER*5 OVL_FILE_NAME
      CHARACTER*4096 RECLN
      CHARACTER*5 FAMILY_NAMES(:),
     +            OVERLAY_FILES_IN_FAMILY(:,:),
...
C
      CHARACTER*5 OVERLAY_FILE_NAME(NUMBER_OF_DATA_FILES),
...
C
      CHARACTER*3 FILE_TYPES(NUMBER_OF_DATA_FILES),TEST_STRING
      LOGICAL*1 FILE_EXISTS(NUMBER_OF_DATA_FILES),MATCH_FOUND,
     +          THIS_OVERLAY_FILE_EXISTS(0:16)
      LOGICAL*1 INT_EXISTS,DBE_EXISTS,EAE_EXISTS,DDE_EXISTS,EPE_EXISTS,
     +          FAE_EXISTS,
     ...
     +          ENERGY_PRODUCTS_FILE_P2_EXISTS,
...
C
     ...
     +  (FILE_EXISTS(6),EPE_EXISTS),
     +  (FILE_EXISTS(7),PRA_EXISTS),
     +  (FILE_EXISTS(8),PRF_EXISTS),
     +  (FILE_EXISTS(9),INE_EXISTS),
     +  (FILE_EXISTS(10),TAX_EXISTS),
     +  (FILE_EXISTS(11),INT_EXISTS),
     +  (FILE_EXISTS(12),FIN_EXISTS),
     +  (FILE_EXISTS(13),ESC_EXISTS),
     +  (FILE_EXISTS(14),FOS_EXISTS),
     +  (FILE_EXISTS(15),HYD_EXISTS),
     +  (FILE_EXISTS(16),UPE_EXISTS),
     +  (FILE_EXISTS(17),SFC_EXISTS),
     +  (FILE_EXISTS(18),CFC_EXISTS),
     +  (FILE_EXISTS(19),RFC_EXISTS),
     +  (FILE_EXISTS(20),IFC_EXISTS),
     +  (FILE_EXISTS(21),O1F_EXISTS),
     +  (FILE_EXISTS(22),O2F_EXISTS),
     +  (FILE_EXISTS(23),O3F_EXISTS),
     +  (FILE_EXISTS(24),CLS_EXISTS),
     +  (FILE_EXISTS(25),CLH_EXISTS),
     +  (FILE_EXISTS(26),LMG_EXISTS),
     +  (FILE_EXISTS(27),LMS_EXISTS),
     +  (FILE_EXISTS(28),PFD_EXISTS),
     +  (FILE_EXISTS(29),PNP_EXISTS),
     +  (FILE_EXISTS(30),FNP_EXISTS),
     +  (FILE_EXISTS(31),CNP_EXISTS),
     +  (FILE_EXISTS(32),CRA_EXISTS),
     +  (FILE_EXISTS(33),COS_EXISTS),
     +  (FILE_EXISTS(34),REFERENCE_LOAD_DATA_EXISTS),
     +  (FILE_EXISTS(35),LFI_EXISTS),
     +  (FILE_EXISTS(36),ENV_EXISTS),
     +  (FILE_EXISTS(37),ECO_EXISTS),
     +  (FILE_EXISTS(38),ASTRT_EXISTS),
     +  (FILE_EXISTS(39),ASTVEC_EXISTS),
     +  (FILE_EXISTS(40),CNT_EXISTS),
     +  (FILE_EXISTS(41),PRODP_EXISTS),
     +  (FILE_EXISTS(42),AREA_EXISTS),
     +  (FILE_EXISTS(43),FUEL_INVENTORY_EXISTS),
     +  (FILE_EXISTS(44),FUEL_PRICE_EXISTS),
     +  (FILE_EXISTS(45),SERVICE_TRANSACTIONS_EXISTS),
     +  (FILE_EXISTS(46),FUEL_EMISSIONS_FILE_EXISTS),
     +  (FILE_EXISTS(47),OVER_UNDER_TABLE_EXISTS),
     +  (FILE_EXISTS(48),CLASS_RUN_SPECS_EXISTS),
     +  (FILE_EXISTS(49),CLASS_REVENUE_FORECAST_EXISTS),
     +  (FILE_EXISTS(50),ELIMINATIONS_EXISTS),
     +  (FILE_EXISTS(51),DETAILED_REPORTS_EXISTS),
     +  (FILE_EXISTS(52),NEW_RUN_SPECS_EXISTS),
     +  (FILE_EXISTS(53),CATAWBA2_CONTRACT_EXISTS),
     +  (FILE_EXISTS(54),UNIT_OUTAGE_EXISTS),
     +  (FILE_EXISTS(55),TRANSACT_TIE_EXISTS),
     +  (FILE_EXISTS(56),MONTHLY_PAYABLES_EXISTS),
     +  (FILE_EXISTS(57),DAY_TYPE_EXISTS),
     +  (FILE_EXISTS(58),SCENARIO_MAKER_EXISTS),
     +  (FILE_EXISTS(59),ENERGY_PRODUCTS_EXISTS),
     +  (FILE_EXISTS(60),MARKET_PRICE_EXISTS),
     ...
     +  (FILE_EXISTS(376),RPS_PROGRAM_EXISTS)
      EQUIVALENCE (OVERLAY_FILE_NAME(1),EAE_FILE),
     + (OVERLAY_FILE_NAME(3),DBE_FILE),
     + (OVERLAY_FILE_NAME(2),DDE_FILE),
     + (OVERLAY_FILE_NAME(4),FAE_FILE),
     + (OVERLAY_FILE_NAME(5),NFE_FILE),
     + (OVERLAY_FILE_NAME(6),EPE_FILE),
     + (OVERLAY_FILE_NAME(7),EXPENSE_NAMES_RESERVED),
     + (OVERLAY_FILE_NAME(8),PRF_FILE),
     + (OVERLAY_FILE_NAME(9),INE_FILE),
     + (OVERLAY_FILE_NAME(10),TAX_FILE),
     + (OVERLAY_FILE_NAME(11),INT_FILE),
     + (OVERLAY_FILE_NAME(12),FIN_FILE),
     + (OVERLAY_FILE_NAME(13),ESC_FILE),
     + (OVERLAY_FILE_NAME(14),FOS_FILE),
     + (OVERLAY_FILE_NAME(15),HYD_FILE),
     + (OVERLAY_FILE_NAME(16),UPE_FILE),
     + (OVERLAY_FILE_NAME(17),SFC_FILE),
     + (OVERLAY_FILE_NAME(18),CFC_FILE),
     + (OVERLAY_FILE_NAME(19),RFC_FILE),
     + (OVERLAY_FILE_NAME(20),IFC_FILE),
     + (OVERLAY_FILE_NAME(21),O1F_FILE),
     + (OVERLAY_FILE_NAME(22),O2F_FILE),
     + (OVERLAY_FILE_NAME(23),O3F_FILE),
     + (OVERLAY_FILE_NAME(24),CLS_FILE),
     + (OVERLAY_FILE_NAME(25),CLH_FILE),
     + (OVERLAY_FILE_NAME(26),LMG_FILE),
     + (OVERLAY_FILE_NAME(27),LMS_FILE),
     + (OVERLAY_FILE_NAME(28),PFD_FILE),
     + (OVERLAY_FILE_NAME(29),PNP_FILE),
     + (OVERLAY_FILE_NAME(30),FNP_FILE),
     + (OVERLAY_FILE_NAME(31),CNP_FILE),
     + (OVERLAY_FILE_NAME(32),CRA_FILE),
     ...
     + (OVERLAY_FILE_NAME(376),RPS_PROGRAM_FILE)
      DATA FILE_TYPES/'EAO','DDO','DBO','FAO','NFO','EXO','PAO','PFO',
     + 'INO','TXO','ITO','FRO','ESO','CLO','ELO','UPO',
     + 'SFO','CFO','RFO','IFO','O1O','O2O','O3O','CSO',
     + 'CHO','LGO','LSO','FPO','PNO','FNO','CNO','CRO',
     + 'COO','LDE','LFO','ENO','ECO','ARO','FVO','CTO',
     + 'PPO','AAO','FIO','FCO','TRO','FEO','DAO','ASO',
     + 'RCO','EMO','DEO','RSO','C2O','TEO','TTO','MPO',
     + 'DTO','SMO','TPO','MPO','PAO','RDO','RBO','TFO',
     + 'TIO','ADO','TGO','IPO','TNO','SPO','PRO','WHO',
     + 'SHO','FOO','FBO','WCO','WTO','WDO','79O','80O',
     + '81O','82O','83O','84O','F1O','F2O','F3O','F4O',
     + 'F5O','F6O','F7O','F8O','F9O','C1O','C2O','C3O',
     + 'C4O','C5O','C6O','C7O','PSO','XXX','XXX','XXX',
     + 'XXX','XXX','XXX','XXX','XXX','XXX','XXX','XXX',
     + 'XXX','XXX','XXX','XXX','XXX','XXX','XXX','XXX',
     + 'XXX','XXX','XXX','XXX','XXX','XXX','XXX','XXX',
     + 'XXX','C8O','C9O','C0O','CAO','CBO','CCO','CDO',
     + 'E1O','E2O','E3O','E4O','E5O','E6O','E7O','E8O',
     + 'E9O','E0O','EBO','EDO','EEO','EFO','T1O','T2O',
     + 'T3O','T4O','T5O','T6O','T7O','T8O','T9O','T0O',
     + 'TBO','TDO','THO','TIO','CEO','CGO','EGO','EHO',
     + 'ROO','X1O','X2O','X3O','X4O','X5O','SVO','S1O',
     + 'S2O','S3O','S4O','S5O','S6O','S7O','S8O','S9O',
     + 'UDO','ICO','RMO','GPO','FHO','MRO','WRO','RTO',
     + 'RCO','R1O','R2O','R3O','SGO','EHO','GHO','OHO',
     + 'P2O','P3O','P4O','P5O','CIO','CJO','CKO','CMO',
     + 'CPO','CQO','EIO','P6O','FXO','XXX','XXX','XXX',
     + 'XXX','XXX','XXX','XXX','XXX','XXX','XXX','XXX',
     + 'XXX','XXX','XXX','XXX','XXX','XXX','XXX','XXX',
     + 'XXX','XXX','XXX','XXX','XXX','XXX','XXX','XXX',   ! 240
...
C
      ...
      CALL RETURN_OVERLAY_FAMILY_LIST(OVLNAME,
     +                                MATCH_FOUND,
     +                                OVERLAY_FILE_NAME,
     +                                FILE_EXISTS)
      IF(MATCH_FOUND) THEN
...
!
         ...
         CALL COAL_TRANSPORT_LINKS_MAKEOVL(
     + COAL_TRANSPORT_FILE,'HT') ! 355
...
! CAPITAL RATES DATA
C
         IF(MONTHLY_CAPITIAL_RATES_EXISTS)
...
!        IF(TAX_INFO_FILE_EXISTS) CALL TX_INFO_MAKEOVL(TAX_INFO_FILE)
C
! FUTASSET ASSET FILE
C
         IF(FAE_EXISTS) CALL FA_MAKEOVL(FAE_FILE,0)
         IF(FX_FUTURE_ASSETS_CAPEX_EXISTS)
...
C
         IF(ECO_EXISTS) THEN
            INQUIRE(FILE=trim(OUTPUT_DIRECTORY())//
     +                              "BCECINT.BIN",EXIST=BIN_FILE_EXISTS)
...
C
! FINANICAL RUN SPECS OVERLAY
C
!         IF(FIN_EXISTS) CALL RS_MAKEOVL(FIN_FILE)
C
! DETAILED_REPORTS OVERLAY
C
         IF(DETAILED_REPORTS_EXISTS)
     +                            CALL DE_MAKEOVL(DETAILED_REPORTS_FILE)
C
! CATAWBA_CONTRACT OVERLAY
C
         IF(CATAWBA2_CONTRACT_EXISTS)
     +                         CALL CAT2_MAKEOVL(CATAWBA2_CONTRACT_FILE)
C
! CPL CONTRACT OVERLAY
C
         IF(CPL_CONTRACT_EXISTS)
     +                         CALL CPL_MAKEOVL(CPL_CONTRACT_FILE)
C
! RDI POWERDAT OVERLAY
C
         IF(RDI_POWERDAT_EXISTS)
     +                         CALL RDI_MAKEOVL(RDI_POWERDAT_FILE)
C
! RDI BASECASE OVERLAY
C
         IF(RDI_BASECASE_EXISTS)
     +                         CALL RBC_MAKEOVL(RDI_BASECASE_FILE)
C
...
C
         DO I = 0, 14
            IF(THIS_OVERLAY_FILE_EXISTS(I)) THEN
               ...
               CALL TF_MAKEOVL(OVERLAY_FILE_NAMES,
     +                         THIS_OVERLAY_FILE_EXISTS)
               EXIT
            ENDIF
         ENDDO
!         IF(TRANS_FORECAST_EXISTS) CALL TF_MAKEOVL(TRANS_FORECAST_FILE)
C
! TRANSACTION PATHS OVERLAY! 4/1/98. GAT.
C
         IF(TRANS_PATHS_FILE_EXISTS)
     +                         CALL PATH_MAKEOVL(TRANS_PATHS_FILE)
C
! TRANSACTION CONSTRAINTS OVERLAY! 4/11/98. GAT.
C
         IF(TRANS_CONSTRAINT_FILE_EXISTS)
     +               CALL CONSTRAINT_MAKEOVL(TRANS_CONSTRAINT_FILE)
C
! TRANSACTION GROUPS OVERLAY! 1/9/98. GAT.
C
         IF(TRANS_GROUPS_FILE_EXISTS)
     +                         CALL TG_MAKEOVL(TRANS_GROUPS_FILE)
C
...
C
         DO I = 0, 14
            IF(THIS_OVERLAY_FILE_EXISTS(I)) THEN
               ...
               CALL GAS_DEMAND_FORECAST_MAKEOVL(OVERLAY_FILE_NAMES,
     +                                         THIS_OVERLAY_FILE_EXISTS)
               EXIT
            ENDIF
         ENDDO
...
!
!
         IF(TRAN_EXP_FILE_EXISTS)
     +                        CALL TRAN_EXP_MAKEOVL(TRAN_EXP_FILE)
!
! 071406.
!
         IF(GAS_STORAGE_FILE_EXISTS)
     +                        CALL GAS_STORAGE_MAKEOVL(GAS_STORAGE_FILE)
         IF(GAS_NODE_FILE_EXISTS)
     +                            CALL GAS_NODE_MAKEOVL(GAS_NODE_FILE)
         IF(GAS_WEATHER_DEMAND_EXISTS)
     +          CALL GAS_WEATHER_DEMAND_MAKEOVL(GAS_WEATHER_DEMAND_FILE)
         IF(GAS_TRANSPORT_FILE_EXISTS)
     +                        CALL GAS_LINK_MAKEOVL(GAS_TRANSPORT_FILE)
         IF(GAS_DEMAND_FORECAST_FILE_EXISTS)
     +        CALL GAS_DEMAND_FORECAST_MAKEOVL(GAS_DEMAND_FORECAST_FILE)
!
! 070806.
!
         IF(GAS_SUPPLY_FORECAST_FILE_EXISTS)
...
C
     ...
     +                                           OVERLAY_BOOK_IS_ACTIVE)
     +              CALL EH_MAKEOVL(ELECT_HOUR_MULT_FILE)
!
C
...
C
     ...
     +                                           OVERLAY_BOOK_IS_ACTIVE)
     +              CALL EH_MAKEOVL(GAS_HOUR_MULT_FILE)
!
C
! ELECT_HOUR_MULT_FILE OVERLAY ! 10/23/03
C
         IF(trim(OIL_HOUR_MULT_FILE) /= 'NONE' .AND.
     +                                           OVERLAY_BOOK_IS_ACTIVE)
...
C
         IF(SCENARIO_MAKER_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SCENARIO_MAKER_FILE,0)
         IF(SM_UNITS_S1_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S1,1)
         IF(SM_UNITS_S2_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S2,2)
         IF(SM_UNITS_S3_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S3,3)
         IF(SM_UNITS_S4_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S4,4)
         IF(SM_UNITS_S5_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S5,5)
         IF(SM_UNITS_S6_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S6,6)
         IF(SM_UNITS_S7_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S7,7)
         IF(SM_UNITS_S8_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S8,8)
         IF(SM_UNITS_S9_EXISTS)
     +                CALL SCENARIO_MAKER_MAKEOVL(SM_UNITS_S9,9)
!

! REG_OUT_PARAM OVERLAY ! 06/12/03. GAT.
C
         IF(REGIONAL_PARAMETER_EXISTS)
     +        CALL REG_OUT_PARAM_MAKEOVL(REGIONAL_PARAMETER_FILE,0)
         IF(RM_UNITS_R1_EXISTS)
     +               CALL REG_OUT_PARAM_MAKEOVL(RM_UNITS_R1,1)
         IF(RM_UNITS_R2_EXISTS)
     +               CALL REG_OUT_PARAM_MAKEOVL(RM_UNITS_R2,2)
         IF(RM_UNITS_R3_EXISTS)
     +               CALL REG_OUT_PARAM_MAKEOVL(RM_UNITS_R3,3)
         IF(REGIONAL_OUTAGES_EXISTS)
     +               CALL REG_OUT_PARAM_MAKEOVL(REGIONAL_OUTAGES_FILE,4)
C
! FUEL DERIVATIVES OVERLAY ! 12/23/02. GAT.
C
         IF(FUEL_DERIVATIVES_EXISTS)
...
C
         IF(trim(MARKET_PRICE_FILE) /= 'NONE' .AND.
     +                                           OVERLAY_BOOK_IS_ACTIVE)
...
C
         IF(FUEL_EMISSIONS_FILE_EXISTS)
     +                              CALL FE_MAKEOVL(FUEL_EMISSIONS_FILE)
         IF(SERVICE_TRANSACTIONS_EXISTS)
     +                        CALL TR_MAKEOVL(SERVICE_TRANSACTIONS_FILE)
         IF(CLASS_RUN_SPECS_EXISTS)
     +             CALL CLASS_RUN_SWITCHES_MAKEOVL(CLASS_RUN_SPECS_FILE)
         IF(CLASS_REVENUE_FORECAST_EXISTS .AND. .NOT. WVPA())
     ...
     +                                                .NOT. WVPA()) THEN
      ...
      ELSEIF(.NOT. MATCH_FOUND) THEN
         IF(OVERLAY_BOOK_ACTIVE()) THEN
            WRITE(4,*) 'For endpoint ',endpoint_ord,' no overlay ',
...
! 05/15/03. CLEARS NAME LINE AT BOTTOM OF FILE
     ...
     +           EPE_EXISTS .OR. NFE_EXISTS .OR.
     +           ASTRT_EXISTS .OR. ASTVEC_EXISTS
      RETURN
C***********************************************************************
...
!
            ...
            DOWHILE(IOS == 0)
               ...
               ! SECOND THROUGH N DEFINITION
               READ(10,*,IOSTAT=IOS) DELETE 
            ENDDO
            REWIND(10)
! ADDED 1/4/99. GAT.
!            READ(10,*) DELETE,NUMBER_OF_DEFINITIONS
...
C
     ...
     +                   (OVERLAY_FILES_IN_FAMILY(J,I),
     +                                         J=1,NUMBER_OF_DATA_FILES)
...
C
     ...
     +                                           EXIST=THIS_FILE_EXISTS)
                     ...
                     OVERLAY_FAMILY_ACTIVE(I) =
     +                                     OVERLAY_FAMILY_ACTIVE(I) .OR.
     +                                     OVERLAY_FILE_EXISTS(J,I)
                  ENDIF
               ENDDO
            ENDDO
            CLOSE(10)
